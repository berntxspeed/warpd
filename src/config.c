...
static struct {
	...
	{ "left", "'", "Move the cursor left in normal mode.", OPT_KEY },
	{ "down", "h", "Move the cursor down in normal mode.", OPT_KEY },
	{ "up", "t", "Move the cursor up in normal mode.", OPT_KEY },
	{ "right", "s", "Move the cursor right in normal mode.", OPT_KEY },
	{ "top", "T", "Moves the cursor to the top of the screen in normal mode.", OPT_KEY },
	{ "middle", "M", "Moves the cursor to the middle of the screen in normal mode.", OPT_KEY },
	{ "bottom", "H", "Moves the cursor to the bottom of the screen in normal mode.", OPT_KEY },
