...
static struct {
	...
	{ "grid_activation_key", "M-e", "Activates grid mode and allows for further manipulation of the pointer using the mapped keys.", OPT_KEY },
	...
	{ "grid_up", "t", "Move the grid up.", OPT_KEY },
	{ "grid_left", "'", "Move the grid left.", OPT_KEY },
	{ "grid_down", "h", "Move the grid down.", OPT_KEY },
	{ "grid_right", "s", "Move the grid right.", OPT_KEY },
	{ "grid_cut_up", "T", "Cut the grid up.", OPT_KEY },
	{ "grid_cut_left", "\"", "Cut the grid left.", OPT_KEY },
	{ "grid_cut_down", "H", "Cut the grid down.", OPT_KEY },
	{ "grid_cut_right", "S", "Cut the grid right.", OPT_KEY },
